...
export default class {
  ...
  handleEditTicket(e, bill, bills) { //RP lancé lors du clic sur un ticket
  ...
  handleShowTickets(e, bills, index) { //RP lancé lors du dépliage /pliage des groupes de ticket
